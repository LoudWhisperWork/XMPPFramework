...
- (void)retrievePersonalMessageArchiveAt:(nonnull XMPPJID *)archiveJID
                              withFields:(nullable NSArray<NSXMLElement*> *)fields
                           withResultSet:(nullable XMPPResultSet *)resultSet;

- (void)retrieveGroupMessageArchiveAt:(nonnull XMPPJID *)archiveJID
                           withFields:(nullable NSArray<NSXMLElement*> *)fields
                        withResultSet:(nullable XMPPResultSet *)resultSet;
...
@optional
- (void)xmppMessageArchiveManagement:(XMPPMessageArchiveManagement *)xmppMessageArchiveManagement didFinishReceivingMessagesWithSet:(XMPPResultSet *)resultSet queryId:(NSString *)queryId jid:(XMPPJID *)jid beforeMessageOriginalIdentifier:(NSString *)messageOriginalIdentifier;
...
- (void)xmppMessageArchiveManagement:(XMPPMessageArchiveManagement *)xmppMessageArchiveManagement didFailToReceiveMessages:(nullable XMPPIQ *)error jid:(XMPPJID *)jid;
