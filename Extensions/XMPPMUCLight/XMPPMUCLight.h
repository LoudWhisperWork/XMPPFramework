...
- (void)xmppMUCLight:(nonnull XMPPMUCLight *)sender changedAffiliationWithMessage:(nonnull XMPPMessage *)message userJID:(nonnull XMPPJID *)userJID roomJID:(nonnull XMPPJID *)roomJID;
